    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <Picker.Item
            label='Gerichte mit Reis und Nudeln'
            value='Gerichte mit Reis und Nudeln'
          />
          <Picker.Item label='Gerichte mit Ente' value='Gerichte mit Ente' />
          <Picker.Item
            label='Gerichte mit Schweinefleisch'
            value='Gerichte mit Schweinefleisch'
          />
          <Picker.Item
            label='Gerichte mit Hühnerfleisch'
            value='Gerichte mit Hühnerfleisch'
          />
        </Picker>
        <TouchableOpacity style={styles.button} onPress={onAddProductPress}>
